...
public class LightsTests {
	...
	public void sphereMultiLights() {
		...
		//spot light
		scene1.lights.add(new SpotLight(new Color(600, 0, 0), new Vector(1, 1, -2), new Vector(-200, 100, 50)) //
	...
	public void TrianglesMultiLight() {
		...
		//spot light
		scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Vector(-150100, -1000, 1), new Vector(new Point(10, -10, -130))) //
	...
	public void sphereImproveSpotLights() {
		scene1.geometries.add(sphere);
		//spot light
		scene1.lights.add(new SpotLight(new Color(600, 0, 0), new Vector(1, 1, -2), new Vector(new Point(-200, 100, 50))).setSpecularN(30) //
				.setKl(0.00000005).setKq(0.000000005));
	...
	public void ImproveTrianglesLight() {
		scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.6).setShininess(10)));

		scene2.lights.add(new SpotLight(new Color(600, 0, 250), new Vector(-2, -2, -1), new Vector(new Point(10, -12, -130))).setSpecularN(100) //
				.setKl(0.0001).setKq(0.000005));
